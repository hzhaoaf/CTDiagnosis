...
#
# Created: Tue Oct 22 11:58:57 2013
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.widget.setGeometry(QtCore.QRect(70, 20, 181, 81))
        ...
        self.percent_value_label = QtGui.QLabel(self.widget)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Arial"))
        font.setPointSize(18)
        self.percent_value_label.setFont(font)
        self.percent_value_label.setObjectName(_fromUtf8("percent_value_label"))
        self.horizontalLayout.addWidget(self.percent_value_label)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.percent_value_label.setText(_translate("Dialog", "0", None))
